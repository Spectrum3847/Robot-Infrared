...
public class AutonSingleBallLow extends CommandGroup{
    public AutonSingleBallLow() {
        ...
        this.addSequential(new AutonDrive(Dashboard.AUTON_SINGLE_LOW_DRIVE_FORWARD_SPEED), drive_time);
        this.addSequential(new AutonDrive(Dashboard.AUTON_SINGLE_LOW_DELAY_FORWARD_SPEED), delay_time);
