...
public class SPI extends SensorBase {
     ...
     */
    public SPI(int slot, int csChannel) {
     ...
     */
    public SPI(int slot, int csChannel, boolean csActiveHigh) {
     ...
     * the device is selected is being selected
     */
    public SPI(DigitalOutput cs, boolean csActiveHigh) {
     ...
     * the device is selected is being selected
     */
    private SPI(DigitalOutput cs, boolean csActiveHigh, boolean createdChannel) {
        if (spi == null) {
